<html>
<head>
    <title>Tugas Minggu 6 Romaita</title>
...
class buah
{
    ...
    public function __construct($buahmangga, $buahjambu, $buahsalak){
        $this->mangga = $buahmangga;
        $this->jambu = $buahjambu;
        $this->salak = $buahsalak;
    }
...
?>
    <section>
        <div>
            ...
            <form method="POST" id="belanjaan" name="belanjaan" >
